...
SELECT [InvoiceNo]
      ...
      ,[CustomerID]
      ,[Country]
  FROM [SelormDB].[dbo].[online_retal]

---Cleaning Data

---Total Records = 1,083,818
---270,160 Records have no customerID
---813,658 Records have customerID
...
(
	SELECT [InvoiceNo]
		  ...
		  ,[CustomerID]
		  ,[Country]
	  FROM [dbo].[online_retal]
	  Where CustomerID != 0
)
, quantity_unit_price as (
------ 795,764 records with quantity and unit price
    select *
	 from online_retail
